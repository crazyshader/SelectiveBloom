...
{
    [Serializable]
    [PostProcess(typeof(SelectiveBloomRenderer), PostProcessEvent.AfterStack, "Custom/SelectiveBloom", true)]
    public sealed class SelectiveBloom : PostProcessEffectSettings
    {
        /// <summary>
...
#endif
    internal sealed class SelectiveBloomRenderer : PostProcessEffectRenderer<SelectiveBloom>
    {
        enum Pass
        {
            Prefilter13,
        ...
        public override void Render(PostProcessRenderContext context)
        {
            ...
            var sheet = context.propertySheets.Get(context.resources.shaders.selectiveBloom);
